...
if __name__ == "__main__":
    RRG_Iter = 6
    outputfile = open(outputdir+"PerfectOutput", "w")
    ...
    #             alt_Rounding_theta = rd.altThetawGCM(N, d, saturatedM, RRG_Iter)
    #             Rounding_String =string_Beginning +  " Alt Rounding " + str(RRG_Iter) +" " + str(alt_Rounding_theta)
    #             print(Rounding_String)
    #             outputfile.write( Rounding_String+"\n")
