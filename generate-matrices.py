...
for N in [16,32,64]:
    ...
    for i in range(N):
        for j in range(N):
            uniformdemand[i, j] = 1
            outputfile.write(str(uniformdemand[i,j]/N)+" ")
        outputfile.write("\n")
    outputfile.close()
    ...
    for i in range(N):
        for j in range(N):
            permdemand[i, j] = N if j==(i+N/2)%N else 0
            outputfile.write(str(permdemand[i,j]/N)+" ")
        outputfile.write("\n")
    outputfile.close()
    ...
    for skew in [i/10 for i in range(11)]:
        ...
        for i in range(N):
            for j in range(N):
                ...
                outputfile.write(str(skewdemand[i,j]/N)+" ")
            outputfile.write("\n")
        outputfile.close()
#####################################################################################